...
export const lessonsConfig: LessonConfig[] = [
    ...
    },
    {
        ...
        content: "ौौ औऔ ऐै ऐऐ ौौ औऔ ऐै ऐऐ ौौ औऔ ऐै ऐऐ ौौ औऔ ऐै ऐऐ ौौ औऔ ऐै ऐऐ",
        keys: ['KeyQ', 'KeyW'],
        category: 'upper-row',
        guidance: {
    ...
    },
    {
        ...
        content: "आा आआ ईी ईी आा आआ ईी ईी आा आआ ईी ईी आा आआ ईी ईी आा आआ ईी ईी आा आआ ईी ईी",
    ...
    },
    {
        ...
        content: "ऊू ऊू बब भभ ऊू ऊू बब भभ ऊू ऊू बब भभ ऊू ऊू बब भभ ऊू ऊू बब भभ",
        keys: ['KeyT', 'KeyY'],
        category: 'upper-row',
        guidance: {
            title: 'Upper Row Finger Guidance',
    ...
    },
    {
        ...
        content: "हह ङङ गग घघ हह ङङ गग घघ हह ङङ गग घघ हह ङङ गग घघ हह ङङ गग घघ",
        keys: ['KeyU', 'KeyI'],
        category: 'upper-row',
        guidance: {
            title: 'Upper Row Finger Guidance',
    ...
    },
    {
        ...
        content: "दद धध जज झझ दद धध जज झझ दद धध जज झझ दद धध जज झझ दद धध जज झझ",
        keys: ['KeyO', 'KeyP'],
        category: 'upper-row',
        guidance: {
            title: 'Upper Row Finger Guidance',
    ...
    },
    {
        ...
        content: "डड ढढ ़़ ञञ डड ढढ ़़ ञञ डड ढढ ़़ ञञ डड ढढ ़़ ञञ डड ढढ ़़ ञञ",
    ...
    },
    {
        ...
        content: "र्र् र्र् ंं ंँ र्र् र्र् ंं ंँ र्र् र्र् ंं ंँ र्र् र्र् ंं ंँ र्र् र्र् ंं ंँ",
        keys: ['KeyZ', 'KeyX'],
        category: 'lower-row',
        guidance: {
    ...
    },
    {
        ...
        content: "मम णण नन ऩऩ मम णण नन ऩऩ मम णण नन ऩऩ मम णण नन ऩऩ मम णण नन ऩऩ",
        keys: ['KeyC', 'KeyV'],
        category: 'lower-row',
        guidance: {
            title: 'Lower Row Finger Guidance',
    ...
    },
    {
        ...
        content: "वव ऑऑ लल ळळ वव ऑऑ लल ळळ वव ऑऑ लल ळळ वव ऑऑ लल ळळ वव ऑऑ लल ळळ",
        keys: ['KeyB', 'KeyN'],
        category: 'lower-row',
        guidance: {
            title: 'Lower Row Finger Guidance',
    ...
    },
    {
        ...
        content: "सस शश ,, षष सस शश ,, षष सस शश ,, षष सस शश ,, षष सस शश ,, षष",
        keys: ['KeyM', 'Comma'],
        category: 'lower-row',
        guidance: {
            title: 'Lower Row Finger Guidance',
